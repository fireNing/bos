				...
				<form id="loginform" name="loginform" method="post" class="niceform"
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<div id="codeInputLine" class="loginFormIpt showPlaceholder"
							...
							<img style="cursor: pointer;" id="loginform:vCode" src="${pageContext.request.contextPath }/validatecode.jsp"
								onclick="javascript:document.getElementById('loginform:vCode').src='${pageContext.request.contextPath }/validatecode.jsp?'+Math.random();" />
						</div>
						<a onclick="submitMyform()" href="javascript:void(0);" id="loginform:j_id19" name="loginform:j_id19">
						<script type="text/javascript">
