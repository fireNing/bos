...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div region="center" style="overflow:auto;padding:5px;" border="false">
		<form id="noticebillForm" action="${pageContext.request.contextPath }/NoticeBillAction_addNoticeBill" method="post">
									...
									$.post(
										...
										function(data){
											...
											if(data[0]!=null){
											 ...
											 var delegater = data[0].name;
											 var pickaddress = data[0].address;
