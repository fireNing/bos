...
<script
	...
	type="text/javascript"></script>
<script
	src="${pageContext.request.contextPath }/js/highcharts/modules/exporting.js"
	type="text/javascript"></script>
<script type="text/javascript">
	function doAdd(){
	...
	function doShowHighchartSubarea(){
		$("#highchartWindow").window("open");
		$.post(
			"${pageContext.request.contextPath}/SubareaAction_showSubareaGroupPie",
			function(data){
				var chart = {
	...
	var toolbar = [ {
		...
		text : '显示区域分区图',
		iconCls : 'icon-search',
		handler : doShowHighchartSubarea
	}
	];
	// 定义列
	var columns = [ [ {
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/SubareaAction_subareaList",
			idField : 'id',
			columns : columns,
		...
		$("#btn").click(function(){
			//将表单数据翻译成map形式;
			var tempSearch = $("#searchForm").serializeJson();
			//ajax再次发送请求；
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="subareaForm" action="${pageContext.request.contextPath }/SubareaAction_addSubarea" method="post" >
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							data-options="valueField:'id',textField:'name',mode:'remote',url:'${pageContext.request.contextPath }/RegionAction_shortRegion'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
	...
	<div class="easyui-window" title="查询分区窗口" id="searchWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="searchForm" action="${pageContext.request.contextPath }/SubareaAction_subareaList" method="post" >
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
	...
	<!-- 显示区域分区图 -->
	<div class="easyui-window" title="显示区域分区窗口" id="highchartWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div id="subareaPie" style="overflow:auto;padding:5px;" border="false">
