 ...
 * Generated at: 2018-11-02 14:24:26 UTC
...
public final class staff_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tvar deleteList = $(\"#grid\").datagrid(\"getSelections\");\r\n");
      out.write("\t\tif(deleteList.length == 0){\r\n");
      out.write("\t\t\t$.messager.alert(\"提示信息\",\"请选中删除的取派员！\");\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t$.messager.confirm(\"提示信息\",\"确定删除取派员吗？\",function(y){\r\n");
      out.write("\t\t\t\tif(y){\r\n");
      out.write("\t\t\t\t\tvar array = new Array();\r\n");
      out.write("\t\t\t\t\tfor(var i = 0 ; i < deleteList.length;i++){\r\n");
      out.write("\t\t\t\t\t\tvar staff = deleteList[i];\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/StaffAction_deleteBatch?ids=\"+ids;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t$(\"#editStaff\").form(\"load\",rowData);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t$(function(){\r\n");
      out.write("\t\t$(\"#save\").click(function(){\r\n");
      out.write("\t\t\tvar checkSuccess = $(\"#addStaff\").form(\"validate\");\r\n");
      out.write("\t\t\tif(checkSuccess){\r\n");
      out.write("\t\t\t\t$(\"#addStaff\").submit();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\tvar check  = /^1(3|4|5|7|8)\\d{9}$/;\r\n");
      out.write("\t\t$.extend($.fn.validatebox.defaults.rules, {\r\n");
      out.write("\t\t\tcheckTele : {\r\n");
      out.write("\t\t\t\tvalidator : function(value, param) {\r\n");
      out.write("\t\t\t\t\treturn check.test(value);\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tmessage:'手机输入有误!'\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\tvar isOk = $(\"#editStaff\").form(\"validate\");\r\n");
      out.write("\t\t\tif(isOk){\r\n");
      out.write("\t\t\t\t$(\"#editStaff\").submit();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
      out.write("</script>\r\n");
      ...
      out.write("\t\t\t<form id=\"addStaff\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/StaffAction_addStaff\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>手机</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input data-options=\"validType:'checkTele'\" type=\"text\" name=\"telephone\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>单位</td>\r\n");
      ...
      out.write("\t\t<div region=\"north\" style=\"height:31px;overflow:hidden;\" split=\"false\" border=\"false\" >\r\n");
      out.write("\t\t\t<div class=\"datagrid-toolbar\">\r\n");
      out.write("\t\t\t\t<a id=\"edit\" icon=\"icon-edit\" href=\"javascript:void(0);\" class=\"easyui-linkbutton\" plain=\"true\" >保存</a>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div region=\"center\" style=\"overflow:auto;padding:5px;\" border=\"false\">\r\n");
      out.write("\t\t\t<form id=\"editStaff\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/StaffAction_editStaff\" method=\"post\">\r\n");
